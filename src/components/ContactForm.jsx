...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Using Web3Forms API for email functionality
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          access_key: "93e853ac-fe37-4294-b79d-06e3f2066577", // Replace with your key from web3forms.com
          name: formData.name,
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.p
            className="text-gray-400 mt-8 max-w-2xl mx-auto"
            initial={{ opacity: 0 }}
        ...
        >
          <motion.div
            className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-2xl border border-gray-700/50 p-8 backdrop-blur-sm"
            ...
            <div className="space-y-5">
              ...
              >
                <motion.input
                  ...
                  className="w-full px-4 py-3 bg-gray-900/50 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all"
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.2 }}
          >
            {["About", "Skills", "Projects", "Education"].map((item, index) => (
              <motion.a
                key={item}
